...
# %% ../nbs/00_read.ipynb #db142751
def read_file(path:str):
    "returns file contents"
    with open(path,'r') as f: return f.read()

# %% ../nbs/00_read.ipynb #fcdb0366
